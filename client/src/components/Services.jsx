  ...
  const services = [
    {
      ...
      description:
        "Build strong relationships with journalists and secure top-tier media coverage for your brand.",
    ...
    },
    {
      ...
      description:
        "Develop and maintain a consistent brand identity that resonates with your target audience.",
    ...
    },
    {
      ...
      description:
        "Craft compelling narratives and messaging strategies that drive engagement and action.",
    ...
    },
    {
      ...
      description:
        "Produce high-quality content including press releases, articles, and thought leadership pieces.",
    ...
    },
    {
      ...
      title: "Digital PR",
      description:
        "Leverage digital channels to amplify your message and reach your audience where they are.",
    ...
    },
    {
      ...
      description:
        "Navigate challenging situations with strategic communication and reputation protection.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            We offer a full spectrum of public relations services to elevate
