...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-accent-900 pt-20"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-5xl sm:text-6xl lg:text-8xl font-display font-extrabold text-white mb-8 leading-tight bg-[length:200%_200%]
"
          >
            Elevate Your Brand with
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-300 via-white to-accent-300 animate-gradient bg-[length:200%_200%]
">
          ...
          >
            Transform your brand's narrative with our expert public relations
            services. We craft compelling stories that resonate and drive
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-10 py-5 bg-white text-primary-900 rounded-xl font-bold text-lg hover:bg-primary-50 transition-colors shadow-2xl hover:shadow-3xl flex items-center gap-3 group mx-7"
            >
              Get Started Today
