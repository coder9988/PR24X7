...
const fallbackMediaItems = [
  {
    ...
    description:
      "Breaking news about innovative startup securing major investment round led by top venture capital firms.",
    category: "Startup",
  ...
  },
  {
    ...
    description:
      "Expert analysis of successful crisis communication strategies employed by major corporations.",
    category: "Crisis",
  ...
  },
  {
    ...
    description:
      "The latest public relations strategies shaping the entertainment and media landscape.",
  ...
  },
  {
    ...
    description:
      "How strategic public relations initiatives drive business growth and market expansion.",
    category: "Business",
  ...
  },
  {
    ...
    description:
      "Emerging trends in startup public relations and brand building strategies.",
    category: "Startup",
  ...
  },
  {
    ...
    description:
      "How digital transformation is reshaping entertainment PR and celebrity branding.",
    category: "Entertainment",
  ...
  },
  {
    ...
    description:
      "How traditional businesses are adapting to digital transformation and modern PR strategies.",
    category: "Business",
  ...
  },
  {
    ...
    description:
      "Inspiring journeys of startups that made it big with strategic PR and marketing.",
    category: "Startup",
...
router.get("/:slug", async (req, res) => {
  try {
    ...
    console.log("MongoDB not available, using fallback data");
    // Return fallback data if MongoDB is not available
    const fallbackItem = fallbackMediaItems.find(
...
router.put("/:id", async (req, res) => {
  try {
    const mediaItem = await Media.findByIdAndUpdate(req.params.id, req.body, {
      new: true,
      runValidators: true,
    });
